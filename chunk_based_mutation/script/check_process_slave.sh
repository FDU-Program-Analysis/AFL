...
"-m none -S chunk-afl-png-withdict-slave -x /home/dp/Documents/fuzzing/chunk-afl-evaluation/chunk-afl/png/dict/png.dict"
"-m none -S chunk-afl-jpeg-withdict-slave -x /home/dp/Documents/fuzzing/chunk-afl-evaluation/chunk-afl/jpeg/dict/jpeg.dict"
"-m none -S chunk-afl-mp4-withdict-slave -x /home/dp/Documents/fuzzing/chunk-afl-evaluation/chunk-afl/mp4/dict/mp4.dict"
)
...
while true; do
    ...
    then
        ...
        # then
            ...
            #cd ${log_dir[$i]}
            AFL_SKIP_CRASHES=1 AFL_I_DONT_CARE_ABOUT_MISSING_CRASHES=1 AFL_SKIP_CPUFREQ=1 LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/dp/Documents/install/fuzzing/chunk-afl-evaluation/chunk-afl-install/lib timeout -s INT 6h /home/dp/Documents/install/fuzzing/chunk-afl-evaluation/chunk-afl-install/bin/afl-fuzz -i ${input_dir[$i]} -o ${output_dir[$i]} ${afl_args[$i]} ${binary_path[$i]} ${binary_args[$i]}
            i=`expr $i + 1`
        # fi
    fi
    if [ $i -eq 3 ]
